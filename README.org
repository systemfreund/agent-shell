...
#+HTML: <a href="https://www.youtube.com/watch?v=R2Ucr3amgGg"><img src="https://img.youtube.com/vi/R2Ucr3amgGg/hqdefault.jpg" alt="agent-shell demo" width="70%"/></a>

Here's a [[https://www.youtube.com/watch?v=R2Ucr3amgGg][YouTube video]] showcasing some =agent-shell= features.
...
| agent-shell-context-sources                   | Sources to consider when determining context.                                   |
...
|                 | agent-shell-resume-session                              | Resume a previous session in the current shell.                               |
